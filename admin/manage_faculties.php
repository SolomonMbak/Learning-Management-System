    ...
    <div class="container">
        ...
        <table class="table table-hover table-bordered">
          ...
          <tbody>
            ...
            $qry = mysqli_query($conn,"select * from table_top_category where first_name like '%".mres($conn,$_POST["text_search"])."%' order by top_cat_id asc");

            }else{
              $qry = mysqli_query($conn,"select * from table_top_category order by top_cat_order desc");
            }
